...
If telemetry or remote services are added in a future release, this document must be updated before publication and users must be given explicit notice where required.
